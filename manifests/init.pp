...
class tomcat(
  ...
  if($nativelibrary)
  {
    ...
    exec { "configure native library ${srcdir}":
      command => 'bash -c "./configure --with-apr=/usr/bin/apr-1-config --with-java-home=$(jrunscript -e \'java.lang.System.out.println(java.lang.System.getProperty("java.home"));\')"',
